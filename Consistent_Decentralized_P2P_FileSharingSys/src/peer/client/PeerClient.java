...
public class PeerClient extends UnicastRemoteObject implements PeerClientIF, Runnable { 
	...
	public PeerClient(String name,String ip_address, String  port_no, int numofneighboringpeers, PeerServerIF inst) throws RemoteException {
		...
		//start
		//spun lazy poll function if pull protocol is set
	...
	public void setup(){
		...
		System.out.println("Choose an update protocol settings. Enter number matching an option:");
		...
		//stale file settings
		System.out.println("How do you want to handle stale files? Enter number matching an option:");
